...
namespace Eirene.DAL.Migrations
{
    ...
    [Migration("20260625181813_AddQuestionChoices")]
    partial class AddQuestionChoices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eirene.DAL.Entities.Communication.ChatbotMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Eirene.DAL.Entities.Communication.ChatbotSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Eirene.DAL.Entities.Treatment.QuestionChoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Eirene.DAL.Entities.Communication.ChatbotMessage", b =>
                {
                    b.HasOne("Eirene.DAL.Entities.Communication.ChatbotSession", "Session")
                        .WithMany("Messages")
